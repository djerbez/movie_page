const topmovies = "https://api.themoviedb.org/3/movie/top_rated?api_key=ac611aa60fbb0355792b075ff8337fbe&language=en-US&page=1";
const mainDiv2 = document.querySelector(".container2");
const prefix2 = "https://image.tmdb.org/t/p/w500/"
const addTop = async (movie) => {
    const movies = await fetch(`${topmovies}`).catch((err) =>
      console.log(err));
